...
//=====================================navigation drawer=======================================//
        ...
        imageList.add(new SlideModel(R.drawable.dinajpur_5, ScaleTypes.FIT));
        imageList.add(new SlideModel(R.drawable.dinajpur_4,ScaleTypes.FIT));
        imageList.add(new SlideModel(R.drawable.dinajpur_2,ScaleTypes.FIT));
        imageList.add(new SlideModel(R.drawable.dinajpur3,ScaleTypes.FIT));
        ...
        Button5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Web_browser.WEBSITE_LINK="https://daktarbook.com/advance/search/result?keyword=Dinajpur";
        ...
        Button13.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Web_browser.WEBSITE_LINK="https://www.foodpanda.com.bd/restaurants/new?lat=25.69601&lng=88.65613&vertical=restaurants";
        ...
        Button17.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Web_browser.WEBSITE_LINK="https://bangla.tourtoday.com.bd/?s=&category_name=dinajpur-tour&travel-style=&searching=bangladesh_tour&post_type=post";
                Web_browser.WEBSITE_TITLE="দিনাজপুর জেলার দর্শনীয় স্থান সমূহ";
                Intent myIntent=new Intent(MainActivity.this,Web_browser.class);
                startActivity(myIntent);
